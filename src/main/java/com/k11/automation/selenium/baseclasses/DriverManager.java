...
import com.k11.automation.selenium.baseclasses.constants.Browsers;
...
public class DriverManager {
     ...
     * they do not exists.
     */
    private static final String driverDownloadPath = ConfigurationManager.getBundle().getString("wdm.targetPath");
    ...
    public static WebDriver getBrowser() {
        ...
        if (System.getProperty("browser") == null) {
            ...
            Log.LOGGER.info("Browser is set using environment.properties: " + browsername);
        } else {
